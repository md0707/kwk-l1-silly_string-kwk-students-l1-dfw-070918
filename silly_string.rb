...
favorite_word_in_all_caps = PIZZA.reverse # Put a . after your_favorite word and use a String method.

puts "MY FAVORITE WORD IS PIZZA#{favorite_word_in_all_caps}"
...
sentence = I like to code.gsub("a","o")# Add your gsub chain here
.gsub("a","o")
puts sentence
